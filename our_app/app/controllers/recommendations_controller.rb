class RecommendationsController < ApplicationController
  ...
  private
    ...
    def recommendation_params
      params.require(:recommendation).permit(:Instructor_First_Name, :Instructor_Last_Name, :Instructor_Middle_Name, :Instructor_Email, :Recommended_Student_Email, :Course_Section)
    end
end
